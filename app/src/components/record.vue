...
export default {
	...
	data() {
      ...
      columns: [
        { title: '诊断时间', name: 'date', width: 126, sortable: true },
        { title: '医院', name: 'hospital', width: 126},
        { title: '科室', name: 'category', width: 126},
        { title: '检测项目', name: 'item', width: 126},
